...
void write_data()
{
    ...
    */
    ...
    cout<<"Left Hip"<<filteredAngles[LEFT_HIP][Y_ANGLE]<<endl;
    cout<<"Right Hip"<<filteredAngles[RIGHT_HIP][Y_ANGLE]<<endl;
    cout<<"Hip Average"<<(filteredAngles[LEFT_HIP][Y_ANGLE]+filteredAngles[RIGHT_HIP][Y_ANGLE])/2<<endl;
